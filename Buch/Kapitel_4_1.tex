...
Die soeben beschriebenen Ergebnisse sind natürlich nicht als plausibles Narrativ formuliert, sondern aus einem formal-theoretischen Modellrahmen abgeleitet. Die dort dargestellten Beispiele zeigen, dass bei realen Rigiditäten vor allem Arbeitsmarkt-Effekte, weniger Gütermarkt-Effekte große Wohlfahrtsverluste (Schwankungen im Gesamtoutput) verursachen. Das zentrale Beispiel in \textcite{RomerDavid1990} betrachtet ein Modell in dem der Arbeits- als auch Gütermarkt berücksichtigt werden, und in dem Rigidität bei Gütermarkt-Preisen durch rigide Reallöhne verursacht werden. Das Modell bedient sich zwei Annahmen. 

Erstens, Arbeitsmärkte sind recht unelastisch. Das heißt, dass Unternehmen eher schwer Arbeitnehmer finden und daher ihre Arbeitnehmer nur ungern kündigen. Im Umkehrschluss heißt das aber auch, dass die Unternehmen gewillt sind nominale Preisänderungen recht rasch durchzuführen. Würde man nämlich bei Nachfrage-Rückgängen die Güterpreise hoch belassen (nominale Rigidität), müsste man konsequenterweise Arbeitnehmer kündigen, weil ja weniger Güter verkauft werden als zum Gleichgewichtspreis. Unelastische Arbeitsmärkte implizieren auch eine Prozyklizität der Real Löhne. Bei guter Konjunktur sind freie Arbeitskräfte gefragt aber rar. Durch die Unelastizität der Arbeitsmärkte, müssen die Löhne überproportional angehoben werden, um zusätzliches Personal zu finden.
