...
Die modelltheoretischen Grundlagen \textit{wie} man nominale Rigiditäten berücksichtigen kann waren also schon früh durch \textcite{Taylor1977, Fischer1977}, bzw. \textcite{Calvo1983} geschaffen worden, wie in Kapitel \ref{Nominale Rigiditäten} dargestellt. Unbeantwortet hingegen blieb bislang die Frage, warum es zu diesen nominalen Rigiditäten kommen kann. Die Antwort darauf lieferten \textcite{Mankiw1985b, Akerlof1985, Parkin1986, RomerDavid1990} und \textcite{Ball1988}. Diese Arbeiten stellen den Kern der Neu-Keynesianer 1. Generation dar, weil hier erstmals die zwei wesentlichen Punkte des Neu-Keynesianismus zusammengefügt werden: Erstens, die Monopolistische Konkurrenz als Folge der Nominalen Rigiditäten und zweitens, die Nicht-Neutralität der Geldpolitik.

Die Ausgangsannahme ist, dass die Anpassung von Preisen selbst Kosten verursacht. Daraus leitet sich der von \textcite{Mankiw1985b} geprägte Begriff der "`Menu Costs"', also "`Speisekarten-Kosten"' ab. Dahinter steht folgende exemplarische Idee: Das Drucken neuer Speisekarten kosten Geld. Gastronomen müssen also abschätzen, ab welchem Ausmaß von Preiserhöhungen Mehrerlöse entstehen, die den Druckkostenaufwand wieder ausgleichen \footnote{Die Idee entstand in den 1980er Jahren, also vor der großen digitalen Revolution. Heute wären diese "`Menu Costs"' im Wortsinn vermutlich wesentlich geringer als 1985.}. Eine sehr einfache Idee, die für die meisten individuellen Unternehmer kaum von Belang ist. \textcite{Akerlof1985, Mankiw1985b, Parkin1986} zeigten aber jeweils, dass diese kleinen individuellen Effekte zu großen makroökonomischen Effekten führen können. \textcite{Rotemberg1987} nannte diese Erkenntnis "`PAYM insights"', entlehnt an den Anfangsbuchstaben der vier Autoren. Konkret führt auf Märkten mit Monopolistischer Konkurrenz das individuell Nutzen-maximierendes Verhalten der individuellen Unternehmer \footnote{\textcite[S. 823]{Akerlof1985} nennen es \textit{"Insignifikant"' suboptimales Verhalten}, bzw. \textit{Nahe-Rationales Verhalten}} dazu, dass kleine Preisänderungen von Unternehmen aufgrund der "`Menu Costs"' nicht weitergegeben werden. Kommt es nun zu einem Rückgang der aggregierten Nachfrage, werden Unternehmen bei monopolistischer Konkurrenz ihre Preise aufgrund der "`Menu Costs"' nicht anpassen, sondern stattdessen trotz niedriger Nachfrage den ehemaligen Gleichgewichtspreis verlangen. Gesamtwirtschaftlich optimal wäre es wenn das Unternehmen ihren Preis senken würde. Das würde man auch in der neoklassischen Analyse von Monopolmärkten erwarten. Da das Unternehmen aber "`Menu Costs"' ausgesetzt ist, belässt es den Preis höher. Für das Unternehmen ist das Verhalten Nutzen-maximierend, weil die Preis-Anpassungskosten höher wären als der zusätzliche Gewinn, den das Unternehmen bei geringerem Preis aber höherer abgesetzter Menge, erhalten würde \parencite[S. 372]{Snowdon2005}. Gesamtwirtschaftlich ist das Ergebnis aber suboptimal, weil die abgesetzte Menge beim rigiden Preis viel geringer ist als die Gleichgewichtsmenge.

Die wichtigste Erkenntnis folgt aber noch: Kleine - auf natürliche Schwankungen zurückzuführende - Rückgänge bei der aggregierten Nachfrage, führen über den eben beschriebenen Umweg der durch nominale "`Menu Costs"' verursachten Rigiditäten zu deutlich größeren Rückgängen bei der realen aggregierten Nachfrage. Gesamtwirtschaftlich führt dies zu deutlichen Schwankungen beim Gesamtoutput \parencite[S. 375]{Snowdon2005}. Da solche Schwankungen unerwünscht sind, argumentieren \textcite{Akerlof1985}, dass aktive Wirtschaftspolitik\footnote{\textcite[S.837]{Akerlof1985} schreiben konkret nur von Geldpolitik} sehr wohl einen stabilisierenden und damit wünschenswerten Effekt hat.

HIER WEITER \textcite[S. 375]{Snowdon2005} und Mankiw-Buch Seite 4 weiter.
