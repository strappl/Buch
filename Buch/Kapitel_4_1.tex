...
Vielleicht haben Sie sich beim Lesen schon gefragt: Okay, es gibt einen Unterschied zwischen den Nominalen Rigiditäten - die verzögerte Anpassung des Preises - und Reale Rigiditäten. Was sind aber jetzt Reale Rgiditäten in der Praxis? Das Ausgangsbeispiel mit den Löhnen, die während Zeiten der Deflation nicht sinken, ist nämlich höchst theoretisch. Deflation trat selbst während der "`Great Recession"' nach 2008 nur sehr vereinzelt auf.
Damit beschäftigt sich ein riesiges Forschungsfeld in drei verschiedenen Bereichen: Arbeitsmarkt, Kreditmarkt und Gütermarkt. 

(bzw. verband dieses mit dem Kern: Rigiditäten \textcite[S. 4]{Mankiw1991})
