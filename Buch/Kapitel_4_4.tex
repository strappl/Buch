...
\begin{itemize}
	\item Die Neu-Keynesianische IS-Kurve erklärt die Entwicklung des Output $Y$ durch den Real-Zinssatz $r_t$. Für diesen Real-Zinssatz haben wir eine Zinsregel, die Taylor-Rule. HIER WEITER
\end{itemize}


Die bisher genannten Gleichungen haben zwei große Vorteile. Sie sind, wo notwendig, mikrofundiert, und zukunftsorientiert. Damit entsprechen sie den Anforderungen der Theorie der rationalen Erwartungen. 
